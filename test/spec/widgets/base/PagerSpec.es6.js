    ...
    describe('Pager', () => {
        ...
        describe('Base Testing', () => {
            ...
            it('Normal Pager', () => {
                ...
                expect(dom.refs.container.className).toBe('jpui-pager jpui-pager-normal browser-chrome');
            ...
            it('value and events', () => {
                ...
                expect(dom.refs.container.childNodes[3].className).toBe('jpui-button jpui-button-active browser-chrome');
