        ...
        describe('Base Testing', () => {
            ...
            it('Normal', () => {
                ...
                expect(dom.refs.container.className).toBe(
                    'jpui-dualtreeselector-enterprise jpui-dualtreeselector-enterprise-normal browser-chrome'
                );
                ...
                expect(dom.refs.dropdownContainer.className).toBe('jpui-dropdownlist jpui-dropdownlist-normal browser-chrome');
            ...
            it('dropdown', () => {
                ...
                expect(dom.refs.container.className).toBe(
                    'jpui-dualtreeselector-enterprise jpui-dualtreeselector-enterprise-normal'
                );
                let selector = dom.refs.dualTreeSelector;
                expect(selector.refs.container.className).toBe('jpui-dualtreeselector jpui-dualtreeselector-normal browser-chrome');
