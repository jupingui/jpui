...
define(function (require) {
    ...
    return React.createClass({
        ...
        onUploaderClick: function onUploaderClick(e) {
        ...
        render: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(Renderer, _extends({ value: this.___getValue___() }, this.props))
            );
        }
    });
    ...
    function defaultUploaderRenderer(props) {
        ...
        return React.createElement(
            'div',
            null,
            url ? url : React.createElement(Button, buttonProps)
        );
    }
});