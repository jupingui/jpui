...
define(function (require) {
    ...
    var defaultFilter = function defaultFilter(datasource, filter) {
        filter = filter.trim();
        var filteredData = [];
        if (filter.length > 0) {
        ...
        render: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'jpui-filter-select-layer-content' },
                        React.createElement(
                            'div',
                            { className: 'filter-select-box' },
                            React.createElement(SearchBox, searchProp)
                        ),
                        datasource.length ? React.createElement(
                            'div',
