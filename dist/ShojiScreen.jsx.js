...
define(function (require) {
    ...
    return React.createClass({
        ...
        componentDidMount: function componentDidMount() {
            ...
            workspace.innerHTML = ['<div class="content">', '</div>', '<div class="button-bar">', '<div data-ui-cmd="EnterButtonClick" class="metro-button highlight-button"></div>', '<div data-ui-cmd="CancelButtonClick" class="metro-button normal-button"></div>', '<div class="button-bar-right-container"></div>', '</div>', '<div class="hide-button metro-button highlight-button"></div>'].join('');
        ...
        onButtonBarClick: function onButtonBarClick(e) {
        ...
        renderSubTree: function renderSubTree(props) {
            ...
            if (props.isOpen) {
                ...
                this.___container___.className = 'jpui-shojiscreen' + (typeof className === 'string' && className ? ' ' + className : '') + ' jpui-shojiscreen-' + (typeof skin === 'string' && skin ? skin : 'normal') + (props.className ? ' ' + props.className : '') + (props.showFootBar ? '' : ' jpui-shojiscreen-hide-foot-bar');
                this.___workspace___.style.width = (isNaN(width) ? 1000 : width) + 'px';
                this.___footBarContent___.innerHTML = typeof props.footBarInnerHtml === 'string' ? props.footBarInnerHtml : '';
