...
define(function (require) {
    ...
    var MERGE_FROM_PROPS_TO_STYLE = ['width', 'minWidth', 'maxWidth', 'height', 'minHeight', 'maxHeight'];
    ...
    return {
         ...
         */
        getValueFromPropsAndStyle: function getValueFromPropsAndStyle(props, key, defaultValue) {
         ...
         */
        openLayerHandlerFactory: function openLayerHandlerFactory(me, flag) {
            return function () {
         ...
         */
        closeLayerHandlerFactory: function closeLayerHandlerFactory(me, flag, layerRef) {
         ...
         */
        containerBaseProps: function containerBaseProps(type, me, options) {
            // 原始集
            var result = {
                ref: 'container',
                style: {},
            ...
            if (!isNaN(options.widthCorrect) && (!isNaN(result.style.width) || (result.style.width + '').indexOf('px') > -1)) {
