...
define(function (require) {
    ...
    return React.createClass({
        ...
        onMainBtnClick: function onMainBtnClick() {
            this.setState({
                layerOpen: true
            });
        },
        onColorPickerChange: function onColorPickerChange(e) {
            this.setState({
        ...
        render: function render() {
            ...
            return React.createElement(
                'div',
                containerProp,
                React.createElement(Renderer, { value: this.___getValue___(), mode: this.props.mode }),
                React.createElement(
                    Layer,
                    layerProp,
                    React.createElement(
