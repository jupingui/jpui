...
define(function (require) {
    ...
    return React.createClass({
        ...
        onLayerMouseEnter: function onLayerMouseEnter() {
        ...
        onWorkerRunning: function onWorkerRunning() {
        ...
        renderSubTree: function renderSubTree(props) {
        ...
        fixedContainer: function fixedContainer(props) {
            if (!this.___layerContainer___) return;
            var layer = this.___layerContainer___;
            var style = props.style || {};
            layer.className = 'jpui-layer jpui-layer-' + (typeof props.skin === 'string' && props.skin.length ? props.skin : 'normal') + (typeof props.className === 'string' && props.className.length ? ' ' + props.className : '');
            var cssText = '';
        ...
        fixedSize: function fixedSize(props) {
            var layer = this.___layerContainer___;
            ...
            width = props.fixedWidthToAnchor && width < props.anchor.offsetWidth ? props.anchor.offsetWidth - 2 : width;
        ...
        fixedVirtualBorder: function fixedVirtualBorder(layerPos, anchor) {
            var config = {
            ...
            layerPos.left += arr[0];
            layerPos.top += arr[1];
            this.___virtualBorder___.style.cssText = 'width:' + arr[2] + 'px' + ';height:' + arr[3] + 'px' + (arr[4] != null ? ';left:' + arr[4] + 'px' : '') + (arr[5] != null ? ';right:' + arr[5] + 'px' : '') + (arr[6] != null ? ';top:' + arr[6] + 'px' : '') + (arr[7] != null ? ';bottom:' + arr[7] + 'px' : '');
        },
        fixedPosition: function fixedPosition(props) {
