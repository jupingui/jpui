...
define(function (require) {
    ...
    return React.createClass({
        ...
        // 主按钮被点击
        onMainButtonClick: function onMainButtonClick(e) {
            if (this.props.disabled) return;
        ...
        // 右侧下拉按钮被点击，弹出列表layer
        onDropDownButtonClick: function onDropDownButtonClick(e) {
            if (this.props.disabled) return;
        ...
        render: function render() {
            ...
            var dropdownButtonProp = {
                className: 'icon-right jpui-icon jpui-icon-arrow-down' + (this.state.layerOpen && hasDatasource && !this.props.disabled ? ' layerOpen' : ''),
                onClick: this.onDropDownButtonClick
            };
            var labelProp = {
                className: 'label-container' + (hasDatasource ? ' marginRight' : '') + (this.props.icon ? ' font-icon ' + this.props.icon : '')
            };
            var layerProp = {
                ref: 'layer',
            ...
            return React.createElement(
                'div',
                containerProp,
                hasDatasource ? React.createElement('div', dropdownButtonProp) : null,
                hasDatasource ? React.createElement('div', { className: 'spliter' }) : null,
                React.createElement(
                    'span',
                    labelProp,
                    this.props.label
