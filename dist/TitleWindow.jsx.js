...
define(function (require) {
    ...
    return React.createClass({
        ...
        onWorkerRunning: function onWorkerRunning() {
            if (!this.props.isOpen || !this.___content___ || !this.___content___.childNodes || !this.___content___.childNodes.length || !this.___content___.childNodes[0]) {
        ...
        renderSubTree: function renderSubTree(props) {
            ...
            if (props.isOpen) {
                ...
                renderSubtreeIntoContainer(this, props.children, this.___content___, function () {
                    ...
                    if (props.isAutoResize && !props.isFullScreen && (!props.size || props.size && !props.size.width && !props.size.height)) {
