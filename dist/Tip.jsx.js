...
define(function (require) {
    ...
    return React.createClass({
        ...
        offsetLayerPosition: function offsetLayerPosition(result) {
        ...
        render: function render() {
            ...
            var layerClassName = ['jpui-tip-layer', 'jpui-tip-layer-' + skin, this.props.layerClassName ? this.props.layerClassName : ''].join(' ');
            return React.createElement(
                'div',
                containerProp,
                typeof Renderer === 'function' ? React.createElement(Renderer, this.props.renderProps) : null,
                React.createElement(
                    Layer,
                    layerProp,
                    React.createElement(
                        ...
                        content ? React.createElement('div', { className: 'tip-content', dangerouslySetInnerHTML: { __html: content } }) : null
                    )
                )
            );
        }
