...
define(function (require) {
    ...
    return React.createClass({
        ...
        onEnterButtonClick: function onEnterButtonClick(e) {
            e = { target: this.refs.container };
            e.target.value = this.state.value1 + ';' + this.state.value2;
            this.___dispatchChange___(e);
            this.setState({ layerOpen: false });
        },
        onCancelButtonClick: function onCancelButtonClick(e) {
            this.setState({ layerOpen: false });
        },
        ...
        onCalendarChange1: function onCalendarChange1(e) {
        ...
        onCalendarChange2: function onCalendarChange2(e) {
            var value = tools.str2date(e.target.value);
        ...
        render: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    Layer,
                    layerProp,
                    factory.layerContentFactory(me)
                )
            );
        }
    });
