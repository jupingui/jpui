...
define(function (require) {
    ...
    return React.createClass({
        ...
        onExpanderClick: function onExpanderClick(e) {
            var value = {
        ...
        render: function render() {
            ...
            return React.createElement(
                'td',
                { key: 'row-expander', style: this.props.style },
                React.createElement('div', { className: buttonClass, onClick: this.onExpanderClick, style: { cursor: 'pointer' } })
            );
        }
    });
});